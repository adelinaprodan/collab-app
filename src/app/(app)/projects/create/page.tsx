          ...
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-5 shadow-sm">
            ...
            <form onSubmit={handleCreate} className="mt-4 space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-xl border border-[rgb(var(--border))] bg-white px-4 py-2 text-sm font-medium text-[rgb(var(--text))] hover:bg-[rgb(var(--muted))] transition disabled:opacity-60"
                  onClick={() => {
                    setName("");
                    setDescription("");
                    setCreateError("");
